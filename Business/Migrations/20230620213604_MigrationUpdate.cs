    ...
    public partial class MigrationUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultPhotos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePohot = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionPostId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_ProfileAccounts_ProfileAccountId",
                        column: x => x.ProfileAccountId,
                        principalTable: "ProfileAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_QuestionPosts_QuestionPostId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Photos_QuestionPosts_QuestionPostId",
                        column: x => x.QuestionPostId,
                        principalTable: "QuestionPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vedios_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ProfileAccountId",
                table: "Comments",
                column: "ProfileAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_QuestionPostId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vedios_CommentId",
                table: "Vedios",
                column: "CommentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Vedios_PostId",
                table: "Vedios",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Vedios_QuestionPostId",
                table: "Vedios",
                column: "QuestionPostId");
        }
